...
| [embedded-cargo.md](embedded-cargo.md) | recognising an embedded cargo project |
...
| [breakpoint-budget.md](breakpoint-budget.md) | capping breakpoints for a target that has few |
